...
class PostDamagePostTechModel:
    ...
    def pde_rhs(self, logK, Z, Y, logR, λ3, logξ):
        ...
        X = tf.concat([logK, Z, Y,  λ3, A_g_prime_prime *tf.ones(tf.shape(Y), dtype=Y.dtype) ,logξ, logξ], 1)
    ...
    def train(self):
        ...
        if NBER_folder is not None:
            load_weights_cast(self.v_nn,   self.params['v_nn_config'],   NBER_folder + "/post_tech_post_damage/v_nn_checkpoint_post_tech_post_damage", n_inputs)
            load_weights_cast(self.i_g_nn, self.params['i_g_nn_config'], NBER_folder + "/post_tech_post_damage/i_g_nn_checkpoint_post_tech_post_damage", n_inputs)
            load_weights_cast(self.i_d_nn, self.params['i_d_nn_config'], NBER_folder + "/post_tech_post_damage/i_d_nn_checkpoint_post_tech_post_damage", n_inputs)

        ## Load pretrained weights
        if self.params['pretrained_path'] is not None:
            load_weights_cast(self.v_nn,   self.params['v_nn_config'],   self.params["pretrained_path"] + '/PostDamagePostTech/v_nn_checkpoint_PostDamagePostTech', n_inputs)
            load_weights_cast(self.i_g_nn, self.params['i_g_nn_config'], self.params["pretrained_path"] + '/PostDamagePostTech/i_g_nn_checkpoint_PostDamagePostTech', n_inputs)
            load_weights_cast(self.i_d_nn, self.params['i_d_nn_config'], self.params["pretrained_path"] + '/PostDamagePostTech/i_d_nn_checkpoint_PostDamagePostTech', n_inputs)
