...
prefix="/project/lhansen/Capital_NN_variant/TwoCapital_NN/output"
...
# log_xi_min="-4.0"
# log_xi_max="-3.0"
# log_xi_baseline_min="-4.0"
# log_xi_baseline_max="-3.0"
...
foldername="Four_distortion7_formal_${channel_type}_shortrange_${batch_size}_neurons_${num_neurons}_Agmin_${A_g_prime_min}_Agmax_${A_g_prime_max}_logxi_${log_xi_min}_logxibaseline_${log_xi_baseline_min}_num_iterations${num_iterations1}"
...
job_file="pre_tech_pre_damage.job"
job_output_file="pre_tech_pre_damage.out"
