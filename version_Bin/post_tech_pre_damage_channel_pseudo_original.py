...
Z_0= float(sys.argv[21])
A_d= float(sys.argv[22])
A_g=float(sys.argv[23])
A_g_prime_list=   [float(x) for x in sys.argv[24].split(",")]
eta=float(sys.argv[25])
...
scheduler_num = int(sys.argv[27])
scheduler_size = int(sys.argv[28])
...
"gamma_1" : 0.00017675, "gamma_2" : 2 * 0.0022, "gamma_3_idx" : 1 , "gamma_3_min" : 0.0, "gamma_3_max" : 1.0/3.0, "gamma_3_length" : gamma_3_length,  \
...
"r_1": 1.5, "r_2": 2.5, "y_lower_bar" : 1.5, "log_xi_min" : log_xi_min, "log_xi_max" : log_xi_max, "log_xi_baseline_min" : log_xi_baseline_min, "log_xi_baseline_max" : log_xi_baseline_max, "pretrained_path" : pretrained_path, 'tensorboard' : tensorboard, "learning_rate_schedule_type" : learning_rate_schedule_type , "channel_type": channel_type }
