...
sed -i 's#\\begin{document}#\\usepackage{amssymb}\\usepackage{pdflscape}\\usepackage{float}\\usepackage{capt-of}\\usepackage{fancyhdr}\\pagestyle{fancy}\\fancyhf{}\\fancyhead[L]{\\small Warm and cold starts, and what they select}\\fancyhead[R]{\\small 2026-07-16}\\renewcommand{\\headrulewidth}{0.4pt}\n\\begin{document}#' "$TEX"
...
cp _build/exports/report_tex/report.pdf warmstart_rct_2026-07-16.pdf
echo "PDF -> $(pwd)/warmstart_rct_2026-07-16.pdf"
