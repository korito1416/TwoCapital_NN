...
SEEDS = [7, 8, 9]   # VERIFY: different seeds from prior run [1..6]
A_DS = [0.05, 0.13]
N_COLLO = 256
N_PE = 1000
N_HOWARD = 12
...
# VERIFY: baseline (0.0), the closest-competitor auto, and one fixed-lam spot-check (0.1)
LAMBDAS = [0.0, 0.1, "auto"]   # 0.0 == plain-Howard baseline
