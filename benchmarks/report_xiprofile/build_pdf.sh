...
sed -i 's#\\begin{document}#\\usepackage{amssymb}\\usepackage{pdflscape}\\usepackage{float}\\usepackage{capt-of}\\usepackage{fancyhdr}\\pagestyle{fancy}\\fancyhf{}\\fancyhead[L]{\\small A reporting standard for our NN solutions}\\fancyhead[R]{\\small 2026-07-20}\\renewcommand{\\headrulewidth}{0.4pt}\n\\begin{document}#' "$TEX"
...
cp _build/exports/report_tex/report.pdf reporting_standard_2026-07-20.pdf
echo "PDF -> $(pwd)/reporting_standard_2026-07-20.pdf"
