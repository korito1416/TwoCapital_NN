##################################################################
##################################################################
#### This program solves pre-tech pre-damage models
##################################################################
##################################################################
##################################################################
...
export_folder_output             = sys.argv[14]
...
"num_iterations" : num_iterations, "logging_frequency": logging_frequency, "verbose": True, "load_parameters" : None,
  "norm_weight" : 0.9,  "pretrained_path" : pretrained_path, 'tensorboard' : tensorboard, "learning_rate_schedule_type" : learning_rate_schedule_type  }
...
for log_xi_idx in range(len(log_xi_list)):
    test_model.simulate_path(60, 1.0 / 12.0, log_xi_list[log_xi_idx],   export_folder + "/final_output/pre_tech_pre_damage/log_xi_idx_" + str(log_xi_idx))
