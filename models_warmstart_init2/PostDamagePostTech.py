        ...
        for step in range(self.params["num_iterations"]):
            ...
            if _ck_every > 0 and step > 0 and step % _ck_every == 0:
                ...
                if not os.path.isdir(_ck):
                    ...
                    self.v_nn.save_weights(_ck + "/v_nn_checkpoint_PostDamagePostTech")
                    self.i_g_nn.save_weights(_ck + "/i_g_nn_checkpoint_PostDamagePostTech")
                    self.i_d_nn.save_weights(_ck + "/i_d_nn_checkpoint_PostDamagePostTech")
