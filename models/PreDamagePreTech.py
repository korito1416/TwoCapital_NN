...
class PreDamagePreTechModel:
    ...
    def __init__(self, params):
        ...
        self.v_PreDamageIntermTech_nn.build( (self.params["batch_size"], 6) )
        ...
        self.v_PostDamagePreTech_nn.build( (self.params["batch_size"], 6) )
    ...
    def pde_rhs(self, logK, Z, Y, logR, λ3, logξ):
        ...
        v_PreDamageIntermTech  = self.v_PreDamageIntermTech_nn( tf.concat([ logK, Z, Y, logR, λ3, logξ], 1) )
        ...
        for l in range(L): # L is the number of damage realizations
            ...
            v_PostDamagePreTech  = self.v_PostDamagePreTech_nn( tf.concat([logK, Z, tf.ones(tf.shape(Y)) * y_upper, logR,  λ3_l * tf.ones(tf.shape(Y)), logξ], 1) )
