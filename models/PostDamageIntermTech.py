"""
Solve  post-damage-intermediate-technology  model.
...
class PostDamageIntermTechModel:
    """Post-damage & Intermediate-technology HJB.
    """
    ...
    def __init__(self, params):
        ...
        self.v_PostDamagePostTech_nn.build( (self.params["batch_size"], 7) )
    ...
    def train(self):
        ...
        if self.params['pretrained_path'] is not None:
            ...
            self.i_g_nn.load_weights( self.params["pretrained_path"]  + '/PostDamageIntermTech/i_g_nn_checkpoint_PostDamageIntermTech')
            self.i_d_nn.load_weights( self.params["pretrained_path"]  + '/PostDamageIntermTech/i_d_nn_checkpoint_PostDamageIntermTech')
            self.i_r_nn.load_weights( self.params["pretrained_path"]  + '/PostDamageIntermTech/i_r_nn_checkpoint_PostDamageIntermTech')
        ...
        self.v_nn.save_weights( self.params["export_folder"] + '/v_nn_checkpoint_PostDamageIntermTech')
        self.i_g_nn.save_weights( self.params["export_folder"] + '/i_g_nn_checkpoint_PostDamageIntermTech')
        self.i_d_nn.save_weights( self.params["export_folder"] + '/i_d_nn_checkpoint_PostDamageIntermTech')
        self.i_r_nn.save_weights( self.params["export_folder"] + '/i_r_nn_checkpoint_PostDamageIntermTech')
...
if __name__ == '__main__':
    ...
    test_model = PostDamageIntermTechModel(params)
