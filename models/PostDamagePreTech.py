...
class PostDamagePreTechModel:
    ...
    def pde_rhs(self, logK, Z, Y, logR, λ3, logξ):
        ...
        v_PostDamageIntermTech  = self.v_PostDamageIntermTech_nn( tf.concat([logK, Z, Y, logR, λ3 , logξ], 1) )
        ...
        Jump_term =  J_g_prime * g_l_prime * (v_PostDamageIntermTech - v) + ξ * J_g_prime * (1- g_l_prime+ g_l_prime * tf.math.log(g_l_prime) )\
                    + J_g_prime_prime * g_l_prime_prime * (v_PostDamagePostTech - v) + ξ * J_g_prime_prime * (1- g_l_prime_prime+ g_l_prime_prime * tf.math.log(g_l_prime_prime) )  
