...
class PreDamagePreTechModel:
    ...
    def pde_rhs(self, logK, Z, Y, logR, λ3, logξ):
        ...
        g_l_prime_prime = tf.exp(tf.clip_by_value(-1/ξ * (v_PreDamagePostTech - v), -35.0, 35.0))
        ...
        if self.use_intermediate_tech_jump:
            ...
            g_l_prime = tf.exp(tf.clip_by_value(-1/ξ * (v_PreDamageIntermTech - v), -35.0, 35.0))
        ...
        for l in range(L): # L is the number of damage realizations
            ...
            g_l = tf.exp(tf.clip_by_value(-1/ξ * (v_PostDamagePreTech - v), -35.0, 35.0))
