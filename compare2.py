...
A_g_prime                                               = float(sys.argv[9])
pretrained_path                                         = sys.argv[10]
logging_frequency                                       = int(sys.argv[11])
learning_rates                                          = [float(x) for x in sys.argv[12].split(",")]
hidden_layer_activations                                = sys.argv[13].split(",")
output_layer_activations                                = sys.argv[14].split(",")
num_hidden_layers                                       = int(sys.argv[15])
num_neurons                                             = int(sys.argv[16])
learning_rate_schedule_type                             = sys.argv[17]
delta                                                   = float(sys.argv[18])
